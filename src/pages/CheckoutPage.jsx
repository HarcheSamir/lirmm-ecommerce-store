...
export default function CheckoutPage() {
    ...
    // *** CRITICAL FIX: Add `trigger` to manually trigger validation ***
    ...
    useEffect(() => {
        // When payment method changes, we need to re-validate the form
        trigger();
    ...
    // *** THE CORRECTED SUBMIT HANDLER ***
    const onSubmit = async () => {
        // Manually trigger validation for the fields that are currently required.
        ...
        // If validation passes, get the current form values
    ...
    return (
        <div className="font-sans bg-white min-h-screen">
            {/* The form now calls a simple function that handles validation before calling the real submit handler */}
                        ...
                        <div className="max-w-lg mx-auto lg:mx-0 lg:ml-auto">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <FormInput name="email" label="Email or mobile phone number" register={register} error={errors.email} type="email" />
