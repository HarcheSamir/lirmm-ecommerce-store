    ...
    return (
        <div className="flex gap-4 py-4 border-b border-gray-200">
            ...
            <div className="flex flex-col flex-grow">
                ...
                {/* Variant info can be added here if available in item object */}
                {/* <p className="text-xs text-gray-500">Color: Blue</p> */}
                    ...
                    {cart?.items?.length > 0 && (
                        <div className="p-6 border-t border-gray-200">
                            ...
                            <div className="grid grid-cols-1 gap-3">
                                <Link to="/checkout" onClick={toggleCart} className="w-full text-center bg-primary text-white py-3 rounded-md font-semibold hover:bg-fblack transition-colors">
                                    Proceed to Checkout
                                </Link>
                                <Link to="/cart" onClick={toggleCart} className="w-full text-center bg-gray-100 text-gray-800 py-3 rounded-md font-semibold hover:bg-gray-200 transition-colors">
                                    View Cart
                                </Link>
                            </div>
                        </div>
